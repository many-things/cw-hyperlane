...
describe("pubkeys", () => {
    ...
    describe("isSinglePubkey", () => {
        it("works", () => {
            expect(pubkeys_1.isSinglePubkey(pubkeyEd25519)).toEqual(true);
            expect(pubkeys_1.isSinglePubkey(pubkeySecp256k1)).toEqual(true);
            expect(pubkeys_1.isSinglePubkey(pubkeyMultisigThreshold)).toEqual(false);
        });
    });
    describe("isMultisigThresholdPubkey", () => {
        it("works", () => {
            expect(pubkeys_1.isMultisigThresholdPubkey(pubkeyEd25519)).toEqual(false);
            expect(pubkeys_1.isMultisigThresholdPubkey(pubkeySecp256k1)).toEqual(false);
            expect(pubkeys_1.isMultisigThresholdPubkey(pubkeyMultisigThreshold)).toEqual(true);
        });
    });
});
