...
import { Contract, ContractContext, HplIgpGasOracleInstantiateMsg } from "../types";
import { getWasmPath } from "../load_wasm";
import fs from "fs";


export default class HplIgpGasOracle implements Contract {
  contractName: string = "hpl_igp_gas_oracle"
