...
import { Contract, ContractContext, HplIsmMultisigInstantiateMsg } from "../types";
import { getWasmPath } from "../load_wasm";
import fs from "fs";


export default class HplIsmMultisig implements Contract {
  ...
  instantiate = async(msg: any): Promise<ContractContext> => {
    const instantiateMsg = msg as HplIsmMultisigInstantiateMsg;
