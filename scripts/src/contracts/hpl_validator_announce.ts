...
import { Contract, ContractContext, HplValidatorAnnounceInstantiateMsg } from "../types";
import { getWasmPath } from "../load_wasm";
import fs from "fs";


export default class HplValidatorAnnounce implements Contract {
  ...
  instantiate = async(msg: any): Promise<ContractContext> => {
    const instantiateMsg = msg as HplValidatorAnnounceInstantiateMsg;
